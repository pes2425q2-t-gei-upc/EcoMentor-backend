...
@Service
@Transactional
public class GetCertificateByPhotovoltaicSolar {
    private final CertificateRepository certificateRepository;
    private final CertificateMapper certificateMapper;

    public GetCertificateByPhotovoltaicSolar(CertificateRepository certificateRepository, CertificateMapper certificateMapper) {
        this.certificateRepository = certificateRepository;
        this.certificateMapper = certificateMapper;
    }

    public List<CertificateDTO> execute(boolean photovoltaicSolar) {
        List<Certificate> certificates = certificateRepository.findCertificateByPhotovoltaicSolar(photovoltaicSolar);
