...
public class GetCertificateByHeatingQualification {
    ...
    public GetCertificateByHeatingQualification(CertificateRepository certificateRepository, CertificateMapper certificateMapper) {
        this.certificateRepository = certificateRepository;
        this.certificateMapper = certificateMapper;
    }
    public List<CertificateDTO> execute(Qualification heatingQualification) {
        List<Certificate> certificates = certificateRepository.findCertificateByheatingQualification(heatingQualification);
