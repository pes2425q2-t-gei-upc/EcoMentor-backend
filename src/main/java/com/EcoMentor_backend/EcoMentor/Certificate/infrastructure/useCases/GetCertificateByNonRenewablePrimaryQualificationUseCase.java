...
public class GetCertificateByNonRenewablePrimaryQualificationUseCase {
    ...
    public GetCertificateByNonRenewablePrimaryQualificationUseCase(CertificateRepository certificateRepository, CertificateMapper certificateMapper) {
        this.certificateRepository = certificateRepository;
        this.certificateMapper = certificateMapper;
    }

    public List<CertificateDTO> execute(Qualification NonRenewablePrimaryQualification) {
            List<Certificate> certificates = certificateRepository.findCertificateByNonRenewablePrimaryQualification(NonRenewablePrimaryQualification);
