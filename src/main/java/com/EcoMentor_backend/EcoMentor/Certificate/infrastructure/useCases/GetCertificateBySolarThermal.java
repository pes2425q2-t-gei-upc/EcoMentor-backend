...
public class GetCertificateBySolarThermal {
    ...
    public GetCertificateBySolarThermal(CertificateRepository certificateRepository, CertificateMapper certificateMapper) {
        this.certificateRepository = certificateRepository;
        this.certificateMapper = certificateMapper;
    }

    public List<CertificateDTO> execute(boolean solarThermal) {
        List<Certificate> certificates = certificateRepository.findCertificateBySolarThermal(solarThermal);
