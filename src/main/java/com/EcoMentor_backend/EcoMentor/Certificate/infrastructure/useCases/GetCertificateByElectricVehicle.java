...
@Service
@Transactional
public class GetCertificateByElectricVehicle {
    private final CertificateRepository certificateRepository;
    private final CertificateMapper certificateMapper;

    public GetCertificateByElectricVehicle(CertificateRepository certificateRepository, CertificateMapper certificateMapper) {
        this.certificateRepository = certificateRepository;
        this.certificateMapper = certificateMapper;
    }

    public List<CertificateDTO> execute(boolean electricVehicle) {
        List<Certificate> certificates = certificateRepository.findCertificateByElectricVehicle(electricVehicle);
