...
public class GetCertificateByLightingQualification {
    ...
    public GetCertificateByLightingQualification(CertificateRepository certificateRepository, CertificateMapper certificateMapper) {
        this.certificateRepository = certificateRepository;
        this.certificateMapper = certificateMapper;
    }

    public List<CertificateDTO> execute(Qualification LightingQualification) {
        List<Certificate> certificates = certificateRepository.findCertificateBylightingQualification(LightingQualification);
