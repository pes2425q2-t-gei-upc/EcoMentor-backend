...
public class GetCertificateByGeothermal {
    ...
    public GetCertificateByGeothermal(CertificateRepository certificateRepository, CertificateMapper certificateMapper) {
        this.certificateRepository = certificateRepository;
        this.certificateMapper = certificateMapper;
    }

    public List<CertificateDTO> execute(boolean geothermal) {
        List<Certificate> certificates = certificateRepository.findCertificateByGeothermal(geothermal);
