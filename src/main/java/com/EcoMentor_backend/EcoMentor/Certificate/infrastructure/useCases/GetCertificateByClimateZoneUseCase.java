...
public class GetCertificateByClimateZoneUseCase {
    ...
    public GetCertificateByClimateZoneUseCase(CertificateRepository certificateRepository, CertificateMapper certificateMapper) {
        this.certificateRepository = certificateRepository;
        this.certificateMapper = certificateMapper;
    }
    public List<CertificateDTO> execute(String climaticZone) {
        List<Certificate> certificates = certificateRepository.findCertificateByClimaticZone(climaticZone);
